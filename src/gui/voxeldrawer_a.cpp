...
int voxelDrawer_a_c::getEdgeNeighbors(const voxel_c * space, int x, int y, int z, int face, int edge, int vx[8*3]) {
...
bool voxelDrawer_a_c::edgeVisible(const voxel_c * space, int x, int y, int z, int face, int edge) {


#if 0 // this code is used to generate the bit matrix in
      // voxel_3_c::getNeighbor  and
      // voxel_4_c::getNeighbor
...
void voxelDrawer_a_c::drawFrame(const voxel_c * space, int x, int y, int z, float edge) {
...
void voxelDrawer_a_c::drawNormalVoxel(const voxel_c * space, int x, int y, int z, float alpha, float edge) {
...
void voxelDrawer_a_c::drawVariableMarkers(const voxel_c * space, int x, int y, int z) {
...
void voxelDrawer_a_c::drawCursor(const voxel_c * space, int mX1, int mX2, int mY1, int mY2, int mZ, int mode) {
