 ...
 */
void disassembler_4_c::prepare(int pn, voxel_type * pieces, node_c * searchnode) {
...
void disassembler_4_c::init_find(node_c * nd, int piecenumber, voxel_type * pieces) {
 ...
 */
node_c * disassembler_4_c::find(node_c * searchnode) {
 ...
 */
separation_c * disassembler_4_c::disassemble_rec(int piecenumber, voxel_type * pieces, node_c * start) {
  ...
  while (!openlist.empty()) {
    ...
    while ((st = find(node))) {
      ...
      std::set<node_c *, node_ptr_less>::iterator it;
