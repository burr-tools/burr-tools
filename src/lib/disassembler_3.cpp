...
disassembler_3_c::disassembler_3_c(voxel_c * problem, int piecenum) : assm(problem), piecenumber(piecenum) {
...
disassembly_c * disassembler_3_c::disassemble(void) {
