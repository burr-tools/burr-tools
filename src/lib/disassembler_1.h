...
private:
  ...
  /* create matrix */
  void prepare(int pn, voxel_type * pieces, node1_c * searchnode);
  void prepare_rec(int pn, int d, int a, int b);
  void init_find(node1_c * nd, int piecenumber, voxel_type * pieces);
   ...
   */
  node1_c * find(node1_c * searchnode);
   ...
   */
  separation_c * disassemble_rec(int piecenumber, voxel_type * pieces, node1_c * start);

public:

  disassembler_1_c(assemblyVoxel_c * prob, int piecenum);
  ~disassembler_1_c();
