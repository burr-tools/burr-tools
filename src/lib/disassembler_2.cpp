...
public:
  ...
  node2_c(int pn) : comefrom(0), piecenumber(pn) {
   ...
   */
  bool operator == (const node2_c &b) const {
  ...
  node2_c * getComefrom(void) const {
    return comefrom;
  }

  void setComefrom(node2_c *n) {
    comefrom = n;
  }
 ...
 */
class node_ptr_less : public std::binary_function<node2_c *, node2_c *, bool> {

public:

  bool operator()(const node2_c * a, const node2_c * b) const {
    return *a < *b;
  }
};
 ...
 */
void disassembler_2_c::prepare(int pn, voxel_type * pieces, node2_c * searchnode) {
...
void disassembler_2_c::init_find(node2_c * nd, int piecenumber, voxel_type * pieces) {
 ...
 */
node2_c * disassembler_2_c::find(node2_c * searchnode) {
 ...
 */
static void create_new_params(node2_c * st, node2_c ** n, voxel_type ** pn, int piecenumber, voxel_type * pieces, int part, bool cond) {
 ...
 */
separation_c * disassembler_2_c::disassemble_rec(int piecenumber, voxel_type * pieces, node2_c * start) {

  std::queue<node2_c *> openlist;
  std::set<node2_c *, node_ptr_less> closed;
  ...
  while (!openlist.empty()) {
    ...
    while ((st = find(node))) {
      ...
      std::set<node2_c *, node_ptr_less>::iterator i;
...
separation_c * disassembler_2_c::disassemble(void) {
   ...
   */
  node2_c * start = new node2_c(piecenumber);
